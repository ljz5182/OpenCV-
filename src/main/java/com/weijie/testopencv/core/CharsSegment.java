...
import static com.weijie.testopencv.core.CoreFunc.getPlateType;
...
import com.weijie.testopencv.util.Convert;

/**
 * @Author: liangjiazhang
 * @Description:
 * @Date: Created in 4:16 PM 2018/8/21
 * @Modified By:
 */
public class CharsSegment {
    ...
    public int charsSegment(final opencv_core.Mat input, Vector<opencv_core.Mat> resultVec) {
        ...
        int w = input.cols();
        int h = input.rows();
        opencv_core.Mat tmpMat = new opencv_core.Mat(input, new Rect((int) (w * 0.1), (int) (h * 0.1),
                (int) (w * 0.8), (int) (h * 0.8)));
    ...
    private Mat preprocessChar(Mat in) {
        ...
        warpAffine(in, warpImage, transformMat, warpImage.size(), INTER_LINEAR,
                opencv_core.BORDER_CONSTANT, new opencv_core.Scalar(0));
